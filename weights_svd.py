...
weights_dir = './RoBERTa/RoBERTaBASE/CoLA/ModelCheckpoints'
best_dir = './RoBERTa/RoBERTaBASE/CoLA/ModelCheckpointsBest/Cheap-R8-Best.pth'
file_prefix = 'Cheap-R8-Epoch'
out_dir = './RoBERTa/RoBERTaBASE/CoLA/ModelLandscapes/Cheap'
bestEpoch = 79
jump = 10
print("Running for RoBERTaBASE model on CoLA dataset with method Cheap")
...
ckpt_list = list(range(0,bestEpoch+1,jump))
if bestEpoch in ckpt_list:
    ckpt_list.remove(bestEpoch)
if bestEpoch - 1 not in ckpt_list:
    ckpt_list.append(bestEpoch-1)
print(ckpt_list)
...
####################
gparam_list = []
gckpt_list = list(range(0,bestEpoch+1,jump))
if bestEpoch not in gckpt_list:
    gckpt_list.append(bestEpoch)
